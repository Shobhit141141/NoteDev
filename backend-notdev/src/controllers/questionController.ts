...
export const createQuestion = async (
    ...
    try {
        ...
        const newQuestion = new Question({
            ...
            solutionLink,
            youtubeLink,
            createdBy, // Set the creator googleId
        });
...
export const deleteQuestion = async (req: Request, res: Response) => {
    ...
    try {
        ...
        if (questionToDelete.createdBy !== usergoogleId) {
            return res
                .status(403)
                .json({
...
export const updateQuestion = async (req: Request, res: Response) => {
    ...
    try {
        ...
        if (questionToUpdate.createdBy !== usergoogleId) {
            return res
                .status(403)
                .json({
