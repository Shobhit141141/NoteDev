...
import csrf from "csurf"; // Import the 'csrf' module
...
app.get("/auth/google/callback", async (req, res) => {
  ...
  try {
    ...
    res.redirect(
      `${process.env.FRONTEND_URL}/?token=${accessToken}&uid=${userData.id}`
    );
  } catch (err) {
...
app.get("/auth/user/profile", csrfProtection, async (req, res) => {
...
app.use("/api/topics", csrfProtection, dsaTopicRoutes);
